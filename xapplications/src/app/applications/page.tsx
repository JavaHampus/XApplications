              ...
              <Card className="shadow-xl flex-col justify-between">
                <CardHeader>
                  <div className="flex flex-row justify-between">
                    ...
                    <Badge className={`${application.status ? "bg-green-800/80 text-green-100" : "bg-red-800/80 text-red-100 hover:bg-red-800/50"}`}>
                ...
                <CardFooter className="space-x-4">
                  <a href={`/admin/edit/${application.id}`} className="w-full">
